...
class PaymentService
{
    ...
    */
	...
	$this->getLogger(__METHOD__)->error('Novalnet::getBankDetailsInformation', $transactionData['amount']);
   ...
   public function getSavedPaymentDetails(&$paymentResponseData)
   {
    ...
    public function doInstalmentVoid($transactionData, $paymentUrl)
    {
	    ...
	    $additionalInfo = json_decode($transactionData['additionalInfo'], true);
		 $this->getLogger(__METHOD__)->error('Novalnet::doInstalmentVoid passed', $additionalInfo['currency']);
