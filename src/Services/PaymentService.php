...
class PaymentService
{
    ...
    */
    ...
    public function performServerCall()
    {
        ...
        $this->getLogger(__METHOD__)->error('Server Request ', $paymentRequestData);
        ...
        $this->getLogger(__METHOD__)->error('Server Response ', $paymentResponseData);
    ...
    */
    ...
    {
		$this->getLogger(__METHOD__)->error('getProcessPaymentUrl ', $this->webstoreHelper->getCurrentWebstoreConfiguration()->domainSsl . '/' . $this->sessionStorage->getLocaleSettings()->language . '/payment/novalnet/processPayment/');
