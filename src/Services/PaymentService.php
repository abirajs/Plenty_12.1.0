    ...
    */
    ...
    public function getInstalmentInformation($transactionData)
    {
	   ...
	   if(isset($transactionData['pending_cycles'])) {
			...
			$InstalmentComments .= 'instalment_cycle_amount : ' .  $this->paymentHelper->convertAmountToSmallerUnit($transactionData['cycle_amount'])  . '  ' . $transactionData['currency'] . PHP_EOL ;
		}
