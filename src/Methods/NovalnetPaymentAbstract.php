...
abstract class NovalnetPaymentAbstract extends PaymentMethodBaseService
{
    ...
    public function isActive(): bool
    {
        ...
        if($isPaymentActive && in_array($this::PAYMENT_KEY, ['NOVALNET_INSTALMENT_INVOICE', 'NOVALNET_INSTALMENT_SEPA'])) {
            $instalmentStatus = $this->paymentService->isInstalmentPaymentToBeDisplayed($this->basketRepository, strtolower($this::PAYMENT_KEY));
            $isPaymentActive = ($instalmentStatus == 'instalment') ? true : false;
        }
