...
class PaymentHelper
{
    ...
    /**
     *
     * @var parcelServicePresetRepository
     */
    ...
    /**
     * Creating shipping profile list
     *
     * @param none
     *  
     * @return array
    ...
    {
		// Get the basket repository
        $basket = $this->basketRepository->load();
        
        // Get the shipping country Id
	    ...
	    // Return the shipping profile list
