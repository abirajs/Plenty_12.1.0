...
class WebhookController extends Controller
{
    ...
    */
    ...
    public function handleInstalment()
    {
        ...
        $webhookComments = sprintf($this->paymentHelper->getTranslatedText('webhook_instalment', $this->orderLanguage), $this->eventData['event']['parent_tid'], $this->eventData['event']['tid'], date('d.m.Y'), date('H:i:s'));
