        ...
        var requestData = {
            ...
            paymentIntent: {
                ...
                callbacks: {
                    ...
                    transactionInfoToUpdate.amount = transactionInfoToUpdate.methods[0].amount + transaction.amount;	        	
                 ...
                 onShippingMethodChange : function(shippingMethod, newShippingMethodResult) {
                    ...
                    let transactionInfoToUpdate = {};
                    // Recalculating the total gross based on the chosen shipping method
                    transactionInfoToUpdate.amount = parseInt(shippingMethod.amount) + transaction.amount;		
